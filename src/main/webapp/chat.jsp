...
<div class="abs cover contaniner">
    <div class="abs cover pnl">
        <div class="top pnl-head" style="padding: 20px ; color: white;" >
            ...
            <span id="logout" style="float: right;color: red;cursor: pointer" onclick="redirectLogin()">退出</span>
        </div>
        <div class="abs cover pnl-body" id="pnlBody">
            <div class="abs cover pnl-left">
                ...
                <div class="abs bottom pnl-text">
                    ...
                    <div class="pnl-support" id="copyright"><a href="http://13.200.61.86/login.html">家里蹲科技,版本所有</a></div>
                </div>
            </div>
